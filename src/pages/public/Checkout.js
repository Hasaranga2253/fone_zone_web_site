...
function Checkout() {
  ...
  // Parse price whether number or string
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-green-400 font-bold">
                      Rs. {(parsePrice(item.price) * (item.quantity || 1)).toLocaleString()}
                    </p>
                  </div>
                ))}
              </div>
            ...
            {/* Payment Options */}
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
              <h2 className="text-xl font-bold mb-6 pb-3 border-b border-gray-700">
                Payment Method
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="border border-gray-600 rounded-xl p-4 flex items-center gap-3 bg-gray-700/30 cursor-pointer">
                ...
                <div className="border border-gray-600 rounded-xl p-4 flex items-center gap-3 bg-gray-700/30 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Use account balance</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 h-fit sticky top-6">
            <h2 className="text-xl font-bold mb-6 pb-3 border-b border-gray-700">Order Summary</h2>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-xl border border-cyan-500 max-w-md w-full">
            ...
            <div className="bg-gray-700/30 rounded-xl p-4 mb-6">
              ...
              <div className="flex justify-between font-bold text-lg mt-3 pt-3 border-t border-gray-600">
                <span>Total:</span>
                <span className="text-cyan-400">Rs. {total.toLocaleString()}</span>
              </div>
            </div>
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="px-6 py-3 bg-gray-600 hover:bg-gray-500 rounded-lg font-medium w-1/2"
              >
                Cancel
              </button>
              <button
                onClick={handleConfirmOrder}
                className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg font-medium hover:from-green-500 hover:to-emerald-500 w-1/2"
              >
                Confirm
              </button>
            </div>
